...
Two independent axes decide a powerful action — *how trusted* (clearance) and *what you're certified to do* (qualification):

| Operator | Clearance | Certs | Offensive scan | Build/deploy a platform |
|---|---|---|---|---|
