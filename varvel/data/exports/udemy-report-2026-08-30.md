# VARVEL Engagement Report — udemy

**Scope:** 104.16.142.237/32, 104.16.143.237/32  
**Authorized by:** marcus · operator · sess-1014

## Executive summary

- Hosts in scope: **2**
- Findings: **8**  (confirmed: **4**, critical: **0**)
- Validation (objective oracle): **0 validated · 8 claimed-unvalidated · 0 refuted · 0 untestable**
- Risk levels: **0 high · 8 medium · 0 info**
- Exploits proven: **0**
- Governance holds (actions the platform blocked in-flight): **2**

## Findings

### [MEDIUM] TLS: overly broad wildcard certificate  `TLS-WILDCARD-BROAD`
- Host: `www.udemy.com` · confidence: **CONFIRMED** (85%)
...
- Exploit: **Wildcard cert subdomain takeover impact proof** — _proposed_
...
### [MEDIUM] TLS: overly broad wildcard certificate  `TLS-WILDCARD-BROAD`
- Host: `yourcompany.udemy.com` · confidence: **CONFIRMED** (85%)
- Validation: **CLAIMED-UNVALIDATED** — never reproduced by the validator gate
- Maps to: A02:2021 Cryptographic Failures · MITRE TA0009 Collection
...
- Host: `udemy` · confidence: **SUSPECTED** (69%)
- Validation: **CLAIMED-UNVALIDATED** — never reproduced by the validator gate
- Note: _validator gate: no objective oracle cited_
- Maps to: A02:2021 Cryptographic Failures · MITRE TA0009 Collection

### [MEDIUM] TLS: overly broad wildcard certificate  `F-02`
- Host: `udemy` · confidence: **SUSPECTED** (69%)
- Validation: **CLAIMED-UNVALIDATED** — never reproduced by the validator gate
- Note: _validator gate: no objective oracle cited_
- Maps to: A02:2021 Cryptographic Failures · MITRE TA0009 Collection

### [MEDIUM] TLS: overly broad wildcard certificate  `F-03`
- Host: `udemy` · confidence: **SUSPECTED** (69%)
- Validation: **CLAIMED-UNVALIDATED** — never reproduced by the validator gate
- Note: _validator gate: no objective oracle cited_
- Maps to: A02:2021 Cryptographic Failures · MITRE TA0009 Collection

### [MEDIUM] TLS: overly broad wildcard certificate  `F-04`
- Host: `udemy` · confidence: **SUSPECTED** (69%)
- Validation: **CLAIMED-UNVALIDATED** — never reproduced by the validator gate
- Note: _validator gate: no objective oracle cited_
- Maps to: A02:2021 Cryptographic Failures · MITRE TA0009 Collection
...
- **HELD** `Read` — enclave-denied (udemy)
- **HELD** `Read` — enclave-denied (udemy)

## OPSEC — detection footprint

Overall detection risk: **HIGH** — peak loudness **5/5**, weighted **3.9/5**, across **67** recorded action(s).

What a defender would have observed (loudest first):

### [5/5] Active exploitation attempt ×4
...
### [2/5] Service / version detection (banner grab) ×25
...
Operational-stealth profile: **NORMAL**. Stayed under the normal budget: 168/300 noise pts (56%), peak loudness 5/5 ≤ ceiling 5, 1 HITL-authorized override(s).

- Noise budget: **168/300** noise-points (**56%** of cap, state: **WARN**)
...
Current detection risk **HIGH** (3.9/5); applying the moves below projects **MODERATE** (2.3/5, −1.6).
...
- **[MED]** TLS: overly broad wildcard certificate (F-02): Enforce TLS with modern ciphers; encrypt sensitive data at rest and in transit.
- **[MED]** TLS: overly broad wildcard certificate (F-03): Enforce TLS with modern ciphers; encrypt sensitive data at rest and in transit.
- **[MED]** TLS: overly broad wildcard certificate (F-04): Enforce TLS with modern ciphers; encrypt sensitive data at rest and in transit.
